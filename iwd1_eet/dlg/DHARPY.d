...
IF ~~ THEN BEGIN 3
  SAY @27492
  IF ~!Alignment(LastTalkedToBy,MASK_GOOD)~ THEN REPLY @27503 GOTO 1
...
IF ~~ THEN BEGIN 4
  SAY @27493
  IF ~GlobalGT("Know_Luremaster","GLOBAL",0)~ THEN REPLY @27506 GOTO 5
  IF ~~ THEN REPLY @27507 GOTO 5
  IF ~GlobalGT("Wyvern_Dead","GLOBAL",0)~ THEN REPLY @27508 GOTO 6
...
IF ~~ THEN BEGIN 5
  ...
  IF ~!Alignment(LastTalkedToBy,MASK_GOOD)~ THEN REPLY @27512 GOTO 1
END
...
IF ~~ THEN BEGIN 7
  ...
  IF ~!Alignment(LastTalkedToBy,MASK_GOOD)~ THEN REPLY @27518 GOTO 1
END
