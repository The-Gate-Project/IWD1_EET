...
IF ~~ THEN BEGIN 3
  SAY @5257
  IF ~Global("Siren_Quest","GLOBAL",1)~ THEN REPLY @5132 GOTO 5
  IF ~Global("Siren_Quest","GLOBAL",0)~ THEN REPLY @34540 GOTO 4
END

IF ~~ THEN BEGIN 4
  SAY @34541
  IF ~~ THEN REPLY @34542 EXIT
END

IF ~~ THEN BEGIN 5
  SAY @34543
  IF ~~ THEN REPLY @34544 DO ~SetGlobal("Siren_Quest","GLOBAL",2)~ GOTO 6
END

IF ~~ THEN BEGIN 6
  SAY @34545
  IF ~~ THEN REPLY @34546 GOTO 7
END

IF ~~ THEN BEGIN 7
  SAY @34547
  IF ~~ THEN REPLY @34548 GOTO 8
END

IF ~~ THEN BEGIN 8
  SAY @34549
  IF ~~ THEN REPLY @34550 GOTO 9
END

IF ~~ THEN BEGIN 9
  SAY @34551
  IF ~~ THEN REPLY @34552 GOTO 10
END

IF ~~ THEN BEGIN 10
  SAY @34553
  IF ~Class(LastTalkedToBy,BARD_ALL)~ THEN REPLY @34554 GOTO 13
