...
ADD_TRANS_TRIGGER DACCALIA  2 ~!Kit(LastTalkedToBy,OHTEMPUS)~ DO 0 2
ADD_TRANS_TRIGGER DACCALIA  3 ~!Kit(LastTalkedToBy,OHTEMPUS)~ DO 4 5
...
//BLOCK DALBION.DLG
ALTER_TRANS DALBION BEGIN 5 END BEGIN 0 END BEGIN "ACTION" ~AddJournalEntry(@3354,QUEST)~ END
//BLOCKEND
...
EXTEND_BOTTOM DAMELIA 8
  ...
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)~ THEN REPLY @1798 DO ~AddJournalEntry(@2073,QUEST)~ GOTO 11
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)~ THEN REPLY @1799 DO ~AddJournalEntry(@2073,QUEST)~ EXIT
END
//BLOCKEND
...
//BLOCK VALESTIS PATCH
ADD_TRANS_TRIGGER DVALESTI 8 ~!Global("Arbor_Total","GLOBAL",4)~ DO 6

EXTEND_BOTTOM     DVALESTI 8 #1
